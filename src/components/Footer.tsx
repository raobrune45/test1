...
export default function Footer() {
  ...
  return (
    <footer className="bg-cdr-bg-brand-spruce text-cdr-text-inverse mt-auto">
      <div className="max-w-[1232px] mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          {/* Brand */}
          <div className="md:col-span-5">
            <div className="flex items-center gap-2.5 mb-4">
              <svg className="w-6 h-6 text-cdr-text-inverse/80" viewBox="0 0 28 28" fill="currentColor">
            ...
            <p className="text-cdr-text-inverse/70 text-sm leading-relaxed max-w-sm">
              {t("description")}
            </p>
          </div>
          ...
          <div className="md:col-span-3">
            <h4 className="text-xs font-semibold tracking-widest uppercase text-cdr-text-inverse/50 mb-4">
              {t("navigation")}
            </h4>
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-2.5 text-sm text-cdr-text-inverse/70">
        ...
        <div className="border-t border-cdr-text-inverse/15 mt-10 pt-8 text-center text-sm text-cdr-text-inverse/40">
